...
import org.graylog.aws.kinesis.KinesisStringConsumer;
...
public class KinesisStringTransport extends ThrottleableTransport {
    private static final Logger LOG = LoggerFactory.getLogger(KinesisStringTransport.class);
    public static final String NAME = "awskinesistrans";
    ...
    private KinesisStringConsumer reader;
    ...
    @Inject
    public KinesisStringTransport(@Assisted final Configuration configuration,
    ...
    private void restartConsumer() {
        kinesisTaskFuture = executor.submit(KinesisStringTransport.this.reader);
    }
    ...
    public void doLaunch(MessageInput input) throws MisfireException {
        ...
        this.reader = new KinesisStringConsumer(
    ...
    @FactoryClass
    public interface Factory extends Transport.Factory<KinesisStringTransport> {
        @Override
        KinesisStringTransport create(Configuration configuration);
